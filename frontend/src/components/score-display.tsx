  ...
  return (
    <>
      {isHighScore && (
        ...
        >
          <div className="bg-amber-500 text-white px-3 py-1 rounded-full text-xs font-bold shadow-md border border-amber-300 flex items-center gap-1">
      ...
      <motion.div
        ...
        className="mb-6 overflow-hidden relative pt-6"
      >
        <div
